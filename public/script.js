...
function applyTheme(t) {
    ...
    if (t === 'dark') {
        ...
        themeIcon.src = 'sun.png'; // при тёмной показываем солнце (чтобы переключить на светлую)
    } else {
        document.documentElement.removeAttribute('data-theme');
        themeIcon.src = 'moon.png'; // при светлой показываем луну (чтобы переключить на тёмную)
    }
}
